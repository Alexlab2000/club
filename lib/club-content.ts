...
const GROUP_ARTICLES: Partial<Record<number, GroupArticle>> = {
  8: {
    ...
    title: "Общая информация",
    intro:
      "Этот раздел собирает базовую карту работы с системой Таро: как читать структуру колоды, на что смотреть в раскладе и каким образом переводить символы в ясный смысл. Материал здесь нужен не для мистификации, а для устойчивой навигации по теме.",
    imageSrc: "/tarot-tree-of-life.jpg",
    imageAlt: "Древо жизни и символическая схема Таро",
    blocks: [
      {
        type: "paragraph",
        title: "Символическая структура: 10 сефирот",
        text:
          "В традиции Древа жизни колода связывается с десятью узлами опыта: от импульса и намерения до формы, результата и возвращения к целому. Такой каркас удобен тем, что позволяет читать карту не изолированно, а внутри общей логики пути.",
      },
      {
        type: "list",
        title: "22 аркана и маршруты смысла",
        items: [
          "Старшие арканы удобно читать как карту переходов между состояниями: они показывают не только событие, но и внутренний способ пройти участок пути.",
          "Если смотреть на аркан как на маршрут, то расклад перестаёт быть набором отдельных карт и становится связным сценарием движения.",
          "Повторяющиеся арканы часто указывают на урок, который возвращается до тех пор, пока человек не меняет способ действия.",
          "Контекст вопроса важнее абстрактных значений: одна и та же карта в теме отношений, денег или решения конфликта раскрывается по-разному.",
        ],
      },
      {
        type: "list",
        title: "Подход: символическое чтение",
        items: [
          "Таро работает лучше, когда карта читается как символ, а не как жёсткая инструкция. Тогда расклад помогает увидеть направление, напряжение и скрытые связи.",
          "Важны не только значения, но и композиция: повтор масти, преобладание чисел, положение в раскладе и соотношение старших и младших арканов.",
          "Полезно держать в голове три слоя чтения: факт ситуации, эмоциональный тон и вектор дальнейшего движения.",
          "Чем точнее сформулирован вопрос, тем чище интерпретация. Размытые вопросы почти всегда рождают размытые ответы.",
        ],
      },
      {
        type: "list",
        title: "Что помогает интерпретации?",
        items: [
          "История вопроса: без неё даже сильный расклад теряет половину смысла.",
          "Наблюдение за повтором: если одна тема возвращается в нескольких картах, это редко случайность.",
          "Честность формулировки: когда вопрос задан прямо, колода отвечает заметно точнее.",
          "Спокойный темп чтения: поспешная трактовка почти всегда делает символ беднее, чем он есть.",
          "Сверка с реальностью: хорошая интерпретация проясняет ситуацию, а не уводит от неё.",
          "Личные заметки: записи по раскладам помогают видеть собственные шаблоны чтения и ошибки.",
        ],
      },
      {
        type: "list",
        title: "Практический ориентир: как использовать материалы раздела",
        items: [
          "Начинайте с общего обзора: базовая логика арканов, мастей и позиций даёт опору для всего остального.",
          "После теории переходите к коротким раскладам, чтобы сразу связывать значение карты с живой ситуацией.",
          "Сопоставляйте трактовки с собственными наблюдениями: так быстрее формируется рабочий язык интерпретации.",
          "Возвращайтесь к этому разделу как к справочнику, когда нужно освежить структуру, а не искать готовый ответ.",
          "Сложные темы лучше разбирать по слоям: вопрос, фон, ограничение, ресурс, следующий шаг.",
          "Если материал вызывает сопротивление, не форсируйте. Лучше сделать паузу и вернуться с более точным запросом.",
        ],
      },
      {
        type: "list",
        title: "Краткие ориентиры",
        items: [
          "Контекст: сначала вопрос, потом карта.",
          "Повтор: одинаковые мотивы усиливают значение.",
          "Слой смысла: различайте событие, чувство и направление.",
          "Проверка: хорошая трактовка делает ситуацию яснее, а не туманнее.",
        ],
      },
      {
        type: "paragraph",
        title: "Вывод",
        text:
          "Этот материал задуман как спокойная вводная карта по разделу Таро. Он не заменяет личную практику, но помогает держать рамку, не теряться в символах и постепенно собирать собственный точный способ чтения.",
      },
      {
        type: "list",
        title: "Если идти дальше по разделу",
        items: [
          "Сначала закрепите базовые значения старших арканов и логику расклада.",
          "Потом переходите к темам мастей, чисел и придворных карт.",
          "Не пытайтесь запомнить всё сразу: лучше собрать несколько устойчивых опор и расширять их постепенно.",
          "Сравнивайте символ и результат в реальной жизни, чтобы система не отрывалась от опыта.",
          "Сложные трактовки лучше разбираются через короткие записи после каждого чтения.",
          "Главная цель не в том, чтобы говорить красиво, а в том, чтобы видеть точнее.",
        ],
      },
    ],
  },
